...
class Settings(BaseSettings):
    ...
    smtp_username: str = Field(default='81077c4da1d3cb', description="Username for SMTP server")
    smtp_password: str = Field(default='9c8a5389a9a10f', description="Password for SMTP server")
